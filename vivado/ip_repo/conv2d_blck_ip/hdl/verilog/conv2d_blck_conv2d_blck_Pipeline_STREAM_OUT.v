...
module conv2d_blck_conv2d_blck_Pipeline_STREAM_OUT (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] t_last_fu_141_p2;
reg   [0:0] t_last_reg_168;
reg   [0:0] t_last_reg_168_pp0_iter1_reg;
reg   [7:0] t_data_reg_173;
reg   [30:0] i_fu_66;
wire   [30:0] add_ln369_fu_129_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_i_1;
wire    ap_block_pp0_stage0;
reg    ap_block_pp0_stage0_01001_grp1;
wire   [31:0] zext_ln369_fu_119_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln369_fu_123_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln369_fu_123_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln369_fu_129_p2 = (ap_sig_allocacmp_i_1 + 31'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001_grp1 = (((out_stream_TREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_gmem0_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((out_stream_TREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_gmem0_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = (((out_stream_TREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_gmem0_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_pp0_stage0_grp1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((out_stream_TREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_gmem0_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
assign icmp_ln369_fu_123_p2 = (($signed(zext_ln369_fu_119_p1) < $signed(out_elems)) ? 1'b1 : 1'b0);
...
assign out_stream_TDATA = t_data_reg_173;

assign out_stream_TKEEP = 1'd1;

assign out_stream_TLAST = t_last_reg_168_pp0_iter1_reg;

assign out_stream_TSTRB = 1'd1;

assign t_last_fu_141_p2 = ((zext_ln369_fu_119_p1 == sub) ? 1'b1 : 1'b0);

assign zext_ln369_fu_119_p1 = ap_sig_allocacmp_i_1;

endmodule //conv2d_blck_conv2d_blck_Pipeline_STREAM_OUT
